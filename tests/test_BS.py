...
def test_oneway_and_parity_BS():
    ...
    for sheet in excel.sheet_names:
        ...
        for _, row in df.iterrows():
            ...
            # for the atol, keep it at a reasonalbly small but not too small as excel and computer noise could get involved at 
